      ...
      >
          ...
          <div className="flex items-center justify-between px-6 sm:px-10 py-4 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <Link
                to="/"
                data-cursor="hover"
                className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 dark:text-white/70 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 transition-colors"
              >
                <ArrowLeft size={14} />
        ...
        <div className="flex-1 flex">
          <AuthBrandPanel
            ...
            bullets={["Secure account", "Instant appointment booking", "Live queue tracking"]}
          />
          ...
          <div className="relative flex-1 flex items-center justify-center px-6 py-10">
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Join Slotly and skip the wait</p>
              </div>
              ...
              <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
                ...
                <Link to="/login" data-cursor="hover" className="text-primary-500 hover:text-primary-600 font-medium">
                  Sign in
                </Link>
              </p>
            </motion.div>
